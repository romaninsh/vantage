...
- Schema-on-source: `SurrealTableShell` owns its [`VistaMetadata`](https://docs.rs/vantage-vista/0.4.9/vantage_vista/struct.VistaMetadata.html) and implements the new `columns` / `references` / `id_column` methods directly.
