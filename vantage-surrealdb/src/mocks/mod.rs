...
//! ```
//!
//! ### Testing with SurrealTableExt
//!
//! ```rust
//! use vantage_surrealdb::{mocks::SurrealMockBuilder, table_ext::SurrealTableExt};
...
//! #[tokio::main]
//! async fn main() {
//!     // Note: Must match the exact query generated by SurrealTableExt
//!     let db = SurrealMockBuilder::new()
//!         .with_query_response("SELECT name, email FROM users", json!([
...
//!         .into_entity::<User>();
//!
//!     let users = table.select_surreal().get().await.unwrap();
