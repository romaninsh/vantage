...
- [Relations & Traversal](./relations.md)
...
- [Optimising Live Diorama Data](./optimising-diorama.md)
  - [The setup](./optimising-diorama/stack.md)
  - [Reading the Debug Stream](./optimising-diorama/debug-stream.md)
  - [Where the Work Happens: Capabilities & Latency](./optimising-diorama/capabilities.md)
  - [Fetching What You Drop](./optimising-diorama/waste.md)
  - [Faults: Errors, Outages & Lies](./optimising-diorama/faults.md)
  - [Locking It In: Cache Regression Tests](./optimising-diorama/regression.md)
