...
INSERT INTO settings (key, value, raw) VALUES
    ...
    ('banner_image',    NULL,        E'\\x89504E470D0A1A0A'),
...
CREATE TABLE IF NOT EXISTS metrics (
    ...
    bounce_rate DOUBLE PRECISION NOT NULL DEFAULT 0.0 CHECK (bounce_rate >= 0.0 AND bounce_rate <= 1.0),
    is_bot      SMALLINT NOT NULL DEFAULT 0,
    recorded_on DATE NOT NULL DEFAULT CURRENT_DATE,
    score       DOUBLE PRECISION GENERATED ALWAYS AS (page_views * (1.0 - bounce_rate)) STORED,
...
ON CONFLICT DO NOTHING;
SELECT setval('metrics_id_seq', 10);
