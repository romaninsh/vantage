...
macro_rules! register_window_case {
    ($engine:expr, value: $V:ty) => {{
        ...
        $engine.register_fn(
            "partition_by",
            $crate::rhai_engine::window_case::window_partition_by::<$V>,
        );
        $engine.register_fn(
            "partition_by",
            $crate::rhai_engine::window_case::window_partition_by_id::<$V>,
        );

        $engine.register_fn(
            "order_by",
            $crate::rhai_engine::window_case::window_order_by::<$V>,
        );
        $engine.register_fn(
            "order_by",
            $crate::rhai_engine::window_case::window_order_by_id::<$V>,
        );

        $engine.register_fn("rows", $crate::rhai_engine::window_case::window_rows::<$V>);
        $engine.register_fn(
            "range",
            $crate::rhai_engine::window_case::window_range::<$V>,
        );

        $engine.register_fn(
            "apply",
            $crate::rhai_engine::window_case::window_apply::<$V>,
        );
        $engine.register_fn(
            "apply",
            $crate::rhai_engine::window_case::window_apply_id::<$V>,
        );

        // Case constructors and methods
        $engine.register_fn(
            "case_when",
            $crate::rhai_engine::window_case::case_new::<$V>,
        );
        ...
        $engine.register_fn(
            "else_",
            $crate::rhai_engine::window_case::case_else_id::<$V>,
        );
        ...
        $engine.register_fn(
            "clone",
            |w: $crate::rhai_engine::RhaiWindow<$V>| -> $crate::rhai_engine::RhaiWindow<$V> { w },
        );
        $engine.register_fn(
            "clone",
            |c: $crate::rhai_engine::RhaiCase<$V>| -> $crate::rhai_engine::RhaiCase<$V> { c },
        );
    }};
}
